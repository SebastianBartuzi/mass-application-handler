...
from src.models import ResponseMailModel, AuthorityModel
...
class PromptService:
    ...
    def _fill_mail_placeholders(self, prompt: str, mail_data: ResponseMailModel) -> str:
    ...
    def get_mail_analysis_prompt(self, mail_data: ResponseMailModel) -> str:
    ...
    def get_teryt_matcher_prompt(self, mail_data: ResponseMailModel, authorities_data: List[AuthorityModel]) -> str:
